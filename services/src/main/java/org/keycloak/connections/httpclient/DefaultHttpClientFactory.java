...
public class DefaultHttpClientFactory implements HttpClientFactory, EnvironmentDependentProviderFactory {
    ...
    public List<ProviderConfigProperty> getConfigMetadata() {
        return ProviderConfigurationBuilder.create()
                ...
                .type("long")
                .helpText("Maximum time of inactivity between two data packets, in milliseconds.")
                .defaultValue(5000L)
                .add()
                .property()
                .name("request-timeout-millis")
                .type("long")
                .helpText("Maximum total time for an outgoing HTTP request to complete, in milliseconds. Set to 0 to disable.")
                .defaultValue(30000L)
                .add()
                .property()
